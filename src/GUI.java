...
//TODO Mystery Table Fix? [ItemEvent_Naniga_Okorukana battle_item_data.o]
...
public class GUI extends Application 
{
    ...
    Image unitVivianImage = new Image(getClass().getResource("/icons/unitVivian.png").toExternalForm());
    ...
    ImageView dropListIconImageView = new ImageView(unknownImage);
    ...
    ImageView piantaPriceImageView = new ImageView(piantaImage);
    ...
    public void start(Stage primaryStage) 
    {
            ...
            @Override public void handle(ActionEvent event)
            {
                ...
                fileSelector.setOnAction(e -> 
                {
                    ...
                    if(fileSelector.getSelectionModel().getSelectedItem().getName().equals("main.dol") || fileSelector.getSelectionModel().getSelectedItem().getName().equals("Start.dol"))
                    {
                        ...
                        dropListIconImageView.setFitWidth(20);
                        dropListIconImageView.setFitHeight(20);
                        dropBox.getChildren().addAll(new Label("Item Drop Tables:", dropListIconImageView));
                        ...
                        itemList.setOnMouseClicked(e2 -> 
                        {
                            ...
                            piantaPriceImageView.setFitWidth(20); piantaPriceImageView.setFitHeight(20); form.add(piantaPriceImageView, 0, 4);
                            form.add(new Label("Pianta Price:"), 1, 4);
                            form.add(piantaPriceField, 2, 4);
                            BPCostImageView.setFitWidth(20); BPCostImageView.setFitHeight(20); form.add(BPCostImageView, 0, 5);
                            form.add(new Label("BP Cost:"), 1, 5);
                            form.add(BPCostField, 2, 5);
                            HPRestoredImageView.setFitWidth(20); HPRestoredImageView.setFitHeight(20); form.add(HPRestoredImageView, 0, 6);
                            form.add(new Label("HP Restored:"), 1, 6);
                            form.add(HPRestoredField, 2, 6);
                            FPRestoredImageView.setFitWidth(20); FPRestoredImageView.setFitHeight(20); form.add(FPRestoredImageView, 0, 7);
                            form.add(new Label("FP Restored:"), 1, 7);
                            form.add(FPRestoredField, 2, 7);
                            SPRestoredImageView.setFitWidth(20); SPRestoredImageView.setFitHeight(20); form.add(SPRestoredImageView, 0, 8);
                            form.add(new Label("SP Restored:"), 1, 8);
                            form.add(SPRestoredField, 2, 8);
                            sortOrderImageView.setFitWidth(20); sortOrderImageView.setFitHeight(20); form.add(sortOrderImageView, 0, 9);
                        ...
                        dropList.setOnMouseClicked(e2 -> 
                        {
                            ...
                            {
                                ImageView dropListDataImageView = new ImageView(strangeSackImage);
                                dropListDataImageView.setFitWidth(20); dropListDataImageView.setFitHeight(20); form.add(dropListDataImageView, 0, dropChecker);
                                ...
                                ImageView tempHoldImageView = new ImageView(unknownImage);
                                tempHoldImageView.setFitHeight(20); tempHoldImageView.setFitWidth(20);

                                form.add(tempHoldImageView, 0, dropChecker);
                                form.add(new Label("Slot " + (i + 1) + " Hold Weight: "), 1, dropChecker);
                                form.add(holdWeightFields.get(i), 2, dropChecker);
                                dropChecker++;

                                ImageView tempDropImageView = new ImageView(unknownImage);
                                tempDropImageView.setFitHeight(20); tempDropImageView.setFitWidth(20);

                                form.add(tempDropImageView, 0, dropChecker);
                        ...
                        shopList.setOnMouseClicked(e2 -> 
                        {
                            ...
                            else if(selected.type.equals("Point Rewards"))
                            {
                                ...
                                for(int i = 0; shopChecker < (shopFields.size() * 2); i++)
                                {
                                    ImageView tempPRView = new ImageView(coinImage);
                                    tempPRView.setFitHeight(20); tempPRView.setFitWidth(20);

                                    form.add(tempPRView, 0, shopChecker);
                ...
                if(isFileOpened)
                {
                    ...
                    if (dest != null) 
                    {
                        try 
                        {
                            ...
                            successBox.getIcons().add(itemsIconImage);
        ...
        aboutButton.setOnAction(new EventHandler<ActionEvent>() 
        {
            @Override public void handle(ActionEvent event)
            {
                ...
                alertBox.getIcons().add(itemsIconImage);

                VBox alertMenu = new VBox();
                alertMenu.setAlignment(Pos.CENTER);
                Text version = new Text("Written by Jemaroo     Version: 1.5.0");
        ...
        UpdateChecker updateChecker = new UpdateChecker("Jemaroo", "TTYDItemDataTool", "1.5.0");
        updateChecker.check();
        if(updateChecker.isUpdateAvailable())
        {
            Stage updateBox = new Stage();
            updateBox.setTitle("Update Available");
            updateBox.getIcons().add(itemsIconImage);
            ...
            updateMessage.setOnMouseClicked(new EventHandler<MouseEvent>() 
            {
                ...
                { 
                    ...
                    if (desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) 
                    {
                        try 
                        {
                            desktop.browse(new URL("https://github.com/Jemaroo/TTYDItemDataTool/releases/latest").toURI());
                        } 
                        catch (Exception e) 
                        {
                            e.printStackTrace();
    ...
    public ImageView determineEnemyUnitIcon(int index)
    {
        ...
        if(index == 0){retIV = new ImageView(unitGoombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 1){retIV = new ImageView(unitParagoombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 2){retIV = new ImageView(unitSpikyGoombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 3){retIV = new ImageView(unitHyperGoombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 4){retIV = new ImageView(unitHyperParagoombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 5){retIV = new ImageView(unitHyperSpikyGoombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 6){retIV = new ImageView(unitGloombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 7){retIV = new ImageView(unitParagloombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 8){retIV = new ImageView(unitSpikyGloombaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 9){retIV = new ImageView(unitKoopaTroopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 10){retIV = new ImageView(unitParatroopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 11){retIV = new ImageView(unitKPKoopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 12){retIV = new ImageView(unitKPParatroopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 13){retIV = new ImageView(unitShadyKoopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 14){retIV = new ImageView(unitShadyParatroopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 15){retIV = new ImageView(unitDarkKoopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 16){retIV = new ImageView(unitKoopatrolImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 17){retIV = new ImageView(unitDarkKoopatrolImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 18){retIV = new ImageView(unitDullBonesImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 19){retIV = new ImageView(unitRedBonesImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 20){retIV = new ImageView(unitDryBonesImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 21){retIV = new ImageView(unitHammerBroImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 22){retIV = new ImageView(unitBoomerangBroImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 23){retIV = new ImageView(unitFireBroImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 24){retIV = new ImageView(unitLakituImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 25){retIV = new ImageView(unitDarkLakituImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 26){retIV = new ImageView(unitSpinyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 27){retIV = new ImageView(unitBuzzyBeetleImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 28){retIV = new ImageView(unitSpikyBuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 29){retIV = new ImageView(unitParabuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 30){retIV = new ImageView(unitSpikyParabuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 31){retIV = new ImageView(unknownImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 32){retIV = new ImageView(unitMagikoopaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 33){retIV = new ImageView(unitGusImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 34){retIV = new ImageView(unitDarkCrawImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 35){retIV = new ImageView(unitBanditImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 36){retIV = new ImageView(unitBigBanditImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 37){retIV = new ImageView(unitBadgeBanditImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 38){retIV = new ImageView(unitSpiniaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 39){retIV = new ImageView(unitSpaniaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 40){retIV = new ImageView(unitSpuniaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 41){retIV = new ImageView(unitFuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 42){retIV = new ImageView(unitGoldFuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 43){retIV = new ImageView(unitGreenFuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 44){retIV = new ImageView(unitFlowerFuzzyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 45){retIV = new ImageView(unitPokeyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 46){retIV = new ImageView(unitPoisonPokeyImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 47){retIV = new ImageView(unitPalePiranhaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 48){retIV = new ImageView(unitPutridPiranhaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 49){retIV = new ImageView(unitFrostPiranhaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 50){retIV = new ImageView(unitPiranhaPlantImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 51){retIV = new ImageView(unitCrazeeDayzeeImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 52){retIV = new ImageView(unitAmazyDayzeeImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 53){retIV = new ImageView(unitPiderImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 54){retIV = new ImageView(unitArantulaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 55){retIV = new ImageView(unitSwooperImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 56){retIV = new ImageView(unitSwoopulaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 57){retIV = new ImageView(unitSwampireImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 58){retIV = new ImageView(unitDarkPuffImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 59){retIV = new ImageView(unitRuffPuffImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 60){retIV = new ImageView(unitIcePuffImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 61){retIV = new ImageView(unitPoisonPuffImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 62){retIV = new ImageView(unitBooImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 63){retIV = new ImageView(unitAtomicBooImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 64){retIV = new ImageView(unitDarkBooImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 65){retIV = new ImageView(unitEmberImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 66){retIV = new ImageView(unitLavaBubbleImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 67){retIV = new ImageView(unitPhantomEmberImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 68){retIV = new ImageView(unitBaldCleftImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 69){retIV = new ImageView(unitHyperBaldCleftImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 70){retIV = new ImageView(unitCleftImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 71){retIV = new ImageView(unitIronCleft1Image); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 72){retIV = new ImageView(unitIronCleft2Image); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 73){retIV = new ImageView(unitHyperCleftImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 74){retIV = new ImageView(unitMoonCleftImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 75){retIV = new ImageView(unitBristleImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 76){retIV = new ImageView(unitDarkBristleImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 77){retIV = new ImageView(unitBobombImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 78){retIV = new ImageView(unitBulkyBobombImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 79){retIV = new ImageView(unitBobulkImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 80){retIV = new ImageView(unitChainChompImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 81){retIV = new ImageView(unitRedChompImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 82){retIV = new ImageView(unitBillBlasterImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 83){retIV = new ImageView(unitBulletBillImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 84){retIV = new ImageView(unitBombshellBillBlasterImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 85){retIV = new ImageView(unitBombshellBillImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 86){retIV = new ImageView(unitDarkWizzerdImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 87){retIV = new ImageView(unitWizzerdImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 88){retIV = new ImageView(unitEliteWizzerdImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 89){retIV = new ImageView(unitBlooperImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 90){retIV = new ImageView(unitHooktailImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 91){retIV = new ImageView(unitBonetailImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 92){retIV = new ImageView(unitRawkHawkImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 93){retIV = new ImageView(unitMachoGrubbaImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 94){retIV = new ImageView(unitDooplissImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 95){retIV = new ImageView(unitDooplissMarioImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 96){retIV = new ImageView(unitCortezImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 97){retIV = new ImageView(unitSmorgImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 98){retIV = new ImageView(unitXNautImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 99){retIV = new ImageView(unitXNautPHDImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 100){retIV = new ImageView(unitEliteXNautImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 101){retIV = new ImageView(unitYuxImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 102){retIV = new ImageView(unitZYuxImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 103){retIV = new ImageView(unitXYuxImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 104){retIV = new ImageView(unitMagnusVonGrappleImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 105){retIV = new ImageView(unitLordCrumpImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
        if(index == 106){retIV = new ImageView(unitVivianImage); retIV.setFitHeight(20); retIV.setFitWidth(20); return retIV;}
    ...
    public ImageView determineShopIcon(ShopData shop)
    {
        ...
        else if(shop.name.equals("Shop Point Rewards Table"))
        {
        ...
        else if(shop.name.equals("Northwinds Mart Sell Item Table"))
        {
            retIV = new ImageView(pinkBobombCustomImage);
        }
        ...
        else if(shop.name.equals("Toad Bros. Bazaar Sell Item Table"))
        {
            retIV = new ImageView(shopToadCustomImage);
        }
        ...
        else if(shop.name.equals("Westside Goods Sell Item Table"))
        {
            retIV = new ImageView(lahlaCustomImage);
        }
        ...
        else if(shop.name.equals("Pungent's Great Tree Shop Sell Item Table"))
        {
            retIV = new ImageView(pungentCustomImage);
        }
        ...
        else if(shop.name.equals("Keelhaul Galleria Sell Item Table"))
        {
            retIV = new ImageView(shopToadCustomImage);
        }
        ...
        else if(shop.name.equals("Niff T.'s Shop Sell Item Table"))
        {
            retIV = new ImageView(shopToadCustomImage);
        }
        ...
        else if(shop.name.equals("Sales Stall Sell Item Table"))
        {
            retIV = new ImageView(serverToadCustomImage);
        }
        ...
        else if(shop.name.equals("Deepdown Depot Sell Item Table"))
        {
            retIV = new ImageView(innkeeperToadCustomImage);
        }
        ...
        else if(shop.name.equals("Souvenir Shop Sell Item Table"))
        {
            retIV = new ImageView(shopToadCustomImage);
        }
        ...
        else if(shop.name.equals("Twilight Shop Sell Item Table"))
        {
            retIV = new ImageView(twilightShopManagerWifeCustomImage);
        }
    ...
    public String fileNameSelector(String name)
    {
        ...
        if(name.equals("tou.rel")){retString = "Glitzville"; return retString;}
        if(name.equals("usu.rel")){retString = "Twilight Town"; return retString;}
    ...
    public ImageView fileImageSelector(String name)
    {
        ...
        if(name.equals("tou.rel")){retIV.setImage(unitRawkHawkImage); return retIV;}
        if(name.equals("usu.rel")){retIV.setImage(twilightShopManagerWifeCustomImage); return retIV;}
